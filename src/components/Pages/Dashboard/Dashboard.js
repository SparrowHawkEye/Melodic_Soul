        ...
        <div className=" py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
          <ul className="space-y-2">
            ...
            <li>
              <Link
                to="/dashboard"
                className="flex tooltip tooltip-accent tooltip-right items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                data-tip="My Profile"
              >
                <svg
